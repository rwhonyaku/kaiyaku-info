...
export const PHASE1_SERVICES: ServiceRecord[] = [
...

  {
    ...
    cancellationTimingNotes: [
      ...
      "年間プラン月々払い、年間プラン一括払い、月々プランで、更新単位や解約条件が分けて掲載されています。",
    ],
    postCancellationAccess: [
    ...
    officialSourceSummary:
      "Adobe Accountヘルプでは、アドビアカウントの「プランを管理」から体験版またはサブスクリプションを解約する流れが説明されています。Apple、Google、Microsoftなどのサードパーティ経由で購入したサブスクリプションは、それぞれの解約手順に従う扱いです。確認メール、アカウントページでの確認、複数プランの個別解約、現在の課金期間終了までのアクセス継続、請求期間内の再アクティベートも確認できます。",
    seoTitle:
      "Adobe Creative Cloudの解約方法・アドビアカウントの確認先",
    seoDescription:
      "Adobe Creative Cloudの解約方法について、アドビアカウントのプラン管理、サードパーティ経由購入、解約後のアクセス、確認メール、返金条件を公式情報にもとづいて整理しています。",
    searchIntentNotes: [
      {
        ...
        items: [
          ...
          "アドビから購入したサブスクリプションは、アドビアカウントから直接解約できます。",
          "Creative Cloud個人版などの条件は、アドビのサブスクリプションおよび解約条件ページにも掲載されています。",
        ],
      },
      {
