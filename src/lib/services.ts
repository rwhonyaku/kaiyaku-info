...
export const PHASE1_SERVICES: ServiceRecord[] = [
...

  {
    ...
    officialLinks: [
      {
        label: "Adobe Account ヘルプ / アドビ体験版またはサブスクリプションの解約",
        url: "https://helpx.adobe.com/jp/account/individual/subscriptions-and-plans/renewals-and-cancellations/cancel-adobe-subscription.html",
      },
      {
        label: "Adobe Account ヘルプ / サブスクリプションの条件と返金ポリシー",
        url: "https://helpx.adobe.com/jp/account/individual/terms-policies-and-regulations/adobe-subscription-terms.html",
      },
      {
        label: "Adobe Account ヘルプ / プランキャンセル後のアカウントアクセス",
        url: "https://helpx.adobe.com/jp/account/individual/subscriptions-and-plans/renewals-and-cancellations/account-access-after-plan-cancellation.html",
      },
      {
        label: "Adobe Account ヘルプ / アドビアカウントの削除",
        url: "https://helpx.adobe.com/jp/account/individual/manage-your-account/delete-adobe-account.html",
      },
    ],
    cancellationEntryPoint: [
      "アドビから購入したサブスクリプションは、アドビアカウントから直接解約できます。",
      "アドビアカウントにログインし、解約するプランで「プランを管理」を選択した後、「プランを解約」を選ぶ流れです。",
      "プランの詳細、解約理由、解約の詳細を確認し、「解約の確認」を選択する手順が案内されています。",
      "サブスクリプション条件のページでは、契約中のサブスクリプション確認先として右上のプランカードが示されています。",
    ],
    billingRouteNotes: [
      "Apple、Google、Microsoftなどのサードパーティプロバイダーから購入したサブスクリプションは、それぞれの解約手順に従う扱いです。",
      "複数のプランを持っている場合は、各プランを個別に解約する必要があります。",
      "1つのプランを解約しても、他のアクティブなプランは解約されないと記載されています。",
    ],
    cancellationTimingNotes: [
      "有料アプリとサービスへのアクセスは、現在の課金期間の終了まで継続されます。",
      "Creative Cloud体験版は、体験版終了前に解約しない限り、終了時にサブスクリプションが自動的に開始されます。",
      "ほとんどのプランでは、最初の購入から14日以内に解約すると全額返金されると説明されています。",
      "Creative Cloudのサブスクリプションは、期間終了前に解約しない限り、期間終了時に自動更新される記載です。",
      "年間プラン一括払いと年間プラン月々払いはサブスクリプション開始日から1年ごと、月々プラン月々払いは1か月ごとの更新です。",
      "年間プラン月々払い、年間プラン一括払い、月々プランで、解約条件が分けて掲載されています。",
    ],
    postCancellationAccess: [
      "プラン解約後もアドビアカウントはアクティブなままです。",
      "無料メンバーシップのメリットへのアクセスは保持されると説明されています。",
      "請求期間内であれば、アドビアカウントからプランを再アクティベートでき、アプリ、サービス、ストレージが復元されると記載されています。",
      "解約後も課金が表示される場合、通常は現在の課金期間の最終課金と説明されています。",
      "サブスクリプションが終了すると、ほとんどのCreative Cloudアプリケーションやサービスは使用できなくなります。",
      "Creative Cloudストレージは5GBが上限となり、上限を超えている場合は30日以内に削減する記載です。",
      "Lightroomの画像は、メンバーシップ終了後も1年間保存されると説明されています。",
      "残りの生成クレジットは、サブスクリプションを解約すると有効期限切れになります。",
    ],
    cancellationVsAccountDeletion: [
      "解約ページは、体験版またはサブスクリプションの解約を扱うページです。",
      "サブスクリプションをキャンセルしても、アドビアカウントは有効なままです。",
      "アドビアカウントの削除は、データとプライバシー設定ページから行う別手続きです。",
      "アカウント削除では、個人情報とコンテンツ、アドビアプリとサービス、クラウド保存ファイル、購入ヒストリー、請求書、アカウント設定へのアクセスが失われると説明されています。",
      "アカウント削除前の確認項目には、アクティブなアドビサブスクリプションの解約が含まれています。",
    ],
    confirmationNotes: [
      "解約後は、アドビからの確認メールを確認するか、アカウントページで解約を確認する案内です。",
      "どのプランがまだアクティブかは、アドビアカウントで確認するよう案内されています。",
      "プランと支払いウィンドウでは、対象プランに含まれているアプリとサービスも確認できます。",
      "アカウント削除では、「アドビアカウントの削除を確認する」を選択した後、正常に削除された状態が示されます。",
    ],
    unavailableOrExceptionNotes: [
      "支払いの処理中、または支払いに問題が発生した場合は、プランを解約できないと記載されています。",
      "支払い処理中や支払い問題がある場合は、24時間待ってから再度試す案内です。",
      "一部の国では、解約時にカスタマーサポートへの連絡が必要とされています。",
    ],
    officialSourceSummary:
      "Adobe Accountヘルプでは、アドビアカウントの「プランを管理」から体験版またはサブスクリプションを解約する流れが説明されています。Apple、Google、Microsoftなどのサードパーティ経由で購入したサブスクリプションは、それぞれの解約手順に従う扱いです。確認メール、アカウントページでの確認、複数プランの個別解約、現在の課金期間終了までのアクセス継続、請求期間内の再アクティベート、アカウント削除との違い、キャンセル後のCreative CloudストレージやLightroom画像の扱いも確認できます。",
    seoTitle:
      "Adobe Creative Cloudの解約方法・アドビアカウントでの確認先",
    seoDescription:
      "Adobe Creative Cloudやアドビのサブスクリプション解約方法について、Adobe Accountのプラン管理、体験版、自動更新、解約後のアクセス、確認メール、返金条件を公式情報にもとづいて整理しています。",
    searchIntentNotes: [
      {
        title: "アドビ株式会社・Adobe Account表記",
        items: [
          "このページでは、アドビから購入したAdobe Creative Cloudの体験版またはサブスクリプションを扱います。",
          "解約手続き先は、Adobe Accountのプラン管理画面です。",
          "サードパーティプロバイダーから購入したサブスクリプションは、Adobe Accountではなく各プロバイダー側の解約手順に分かれます。",
        ],
      },
      {
        title: "プラン解約とアカウント削除",
        items: [
          "Creative Cloudプランの解約後も、アドビアカウントは有効なままです。",
          "アドビアカウントの削除は、データとプライバシー設定から進む別の手続きです。",
          "アカウント削除前の確認項目には、アクティブなサブスクリプションの解約が含まれます。",
        ],
      },
      {
        title: "Creative Cloudとアドビサブスクリプション",
        items: [
          "Adobe Accountヘルプの対象は、アドビ体験版またはサブスクリプションの解約です。",
          "Creative Cloud体験版は、終了前に解約しない限りサブスクリプションが自動的に開始されます。",
          "契約中のサブスクリプションは、プランカードで確認する記載です。",
        ],
      },
      {
        title: "解約できない表示・複数プラン",
        items: [
          "支払いの処理中、または支払いに問題が発生した場合は、プランを解約できないと記載されています。",
          "複数のプランを持っている場合は、各プランを個別に解約する必要があります。",
          "1つのプランを解約しても、他のアクティブなプランは解約されません。",
        ],
      },
      {
        title: "解約後のアカウントと再アクティベート",
        items: [
          "解約後もアドビアカウントはアクティブなままです。",
          "有料アプリとサービスへのアクセスは、現在の課金期間の終了まで継続されます。",
          "請求期間内であれば、アドビアカウントからプランを再アクティベートできる記載があります。",
        ],
      },
      {
        title: "ストレージ・Lightroom・生成クレジット",
        items: [
          "解約後に使用できるCreative Cloudストレージの容量は5GBです。",
          "Lightroomの画像は、メンバーシップ終了後も1年間保存されると説明されています。",
          "残りの生成クレジットは、サブスクリプションを解約すると有効期限切れになります。",
        ],
      },
    ...
    contractRouteNotes: [
      {
        route: "アドビから購入したサブスクリプション",
        management: "アドビアカウントの「プランを管理」",
        notes: [
          "「プランを解約」を選び、詳細確認、理由選択、解約内容確認を経て「解約の確認」を選択する流れです。",
          "契約中のサブスクリプションは、プランカードで確認する記載です。",
        ],
      },
      {
        route: "Apple / Google / Microsoftなどで購入",
        management: "各サードパーティプロバイダーの解約手順",
        notes: [
          "アドビアカウントではなく、それぞれの特定の解約手順に従う扱いです。",
        ],
      },
      {
        route: "複数プランを契約している場合",
        management: "アドビアカウントで各プランを個別確認",
        notes: [
          "どのプランがまだアクティブかは、アドビアカウントで確認するよう案内されています。",
        ],
      },
      {
        route: "Creative Cloud体験版",
        management: "Adobe Accountの体験版またはサブスクリプション管理",
        notes: [
          "体験版終了前に解約しない限り、終了時にサブスクリプションが自動的に開始されます。",
        ],
      },
      {
        route: "アドビアカウント削除",
        management: "データとプライバシー設定",
        notes: [
          "プラン解約とは別の手続きで、削除前の確認項目にアクティブなサブスクリプションの解約が含まれています。",
        ],
      },
    ],
  },

  {
    ...
    officialLinks: [
      {
        ...
        url: "https://support.microsoft.com/ja-JP/accounts-billing/subscriptions/cancel-a-microsoft-365-subscription",
      },
      {
        label: "サポート / Microsoft サブスクリプションの定期請求のオンとオフを切り替える",
        url: "https://support.microsoft.com/ja-JP/accounts-billing/subscriptions/turn-recurring-billing-on-or-off-for-a-microsoft-subscription",
      },
      {
        label: "サポート / Microsoft アカウントの使用を停止する方法",
        url: "https://support.microsoft.com/ja-jp/accounts-billing/manage/how-to-close-your-microsoft-account",
      },
    ],
    officialProcedureSections: [
      {
    ...
    cancellationEntryPoint: [
      ...
      "定期請求をオフにする場合は、account.microsoft.com/services で対象サブスクリプションの「管理」を選び、「定期請求をオフにする」へ進む手順です。",
    ],
    billingRouteNotes: [
      "Google PlayまたはApple App StoreからMicrosoft 365を購入した場合は、キャンセルまたは払い戻しについて各ストア側の扱いに分かれます。",
      "AmazonやHarvey Normanなどのサードパーティ小売業者から購入したMicrosoft 365は、サブスクリプションと請求の管理について販売元へ直接問い合わせる記載です。",
      "サードパーティの課金パートナーから購入した場合、キャンセル、更新、支払い方法の変更、プラン切り替えなどの管理サービスはその課金パートナー側で提供されると説明されています。",
    ],
    cancellationTimingNotes: [
      "キャンセルのオプションが表示されず、「定期請求を有効にする」というリンクが表示される場合は、有効期限がすでに設定されており、その日付以降は課金されません。",
      "サブスクリプションの有効期限が切れるまでは、引き続きサブスクリプションを使用できます。",
    ...
    cancellationVsAccountDeletion: [
      "Microsoft 365のキャンセル記事は、Microsoftアカウントに紐づくサブスクリプションの停止を扱う内容です。",
      "Microsoftアカウントの使用停止は別記事で説明され、閉鎖前にサインインして本人確認を行う流れです。",
      "アカウント閉鎖時は、再開できる期間として30日または60日を選択でき、その期間を過ぎるとデータとコンテンツが削除されると記載されています。",
    ],
    confirmationNotes: [
      ...
      "サブスクリプションが期限切れの場合、製品によっては有効期限と最後の請求を確認できると説明されています。",
    ],
    unavailableOrExceptionNotes: [
    ...
    officialSourceSummary:
      "Microsoft 365のサポートでは、Microsoftアカウントのサービス管理ページからサブスクリプションをキャンセルする流れと、定期請求をオフにする手順が別記事で説明されています。キャンセル項目や定期請求ボタンが表示されない場合の画面表示、サードパーティ購入時の管理先、有効期限まで利用できる扱いも確認できます。取り消し後のクラウドストレージ容量、Outlook.comストレージ、FamilyやPremiumで共有されたユーザーへの影響、Microsoftアカウント閉鎖との違いも記載されています。",
    seoTitle:
      "Microsoft 365の解約方法・定期請求と管理画面の確認先",
    seoDescription:
      "Microsoft 365の解約方法について、Microsoftアカウントのサービス管理、定期請求のオフ、App Store・Google Play・小売業者経由の購入、キャンセル項目が表示されない場合を公式情報にもとづいて整理しています。",
    searchIntentNotes: [
      {
        title: "キャンセルと定期請求オフ",
        items: [
          "Microsoft 365のキャンセルは account.microsoft.com/services/microsoft365 から進む案内です。",
          "定期請求をオフにした場合、今後は課金されず、有効期限までは通常どおり利用できます。",
          "「定期請求を有効にする」が表示されている場合は、定期請求が既にオフになっている状態として説明されています。",
        ],
      },
      {
        title: "管理リンク・購入経路の表示",
      ...
      {
        title: "Microsoftアカウント閉鎖との違い",
        items: [
          "Microsoft 365のキャンセルは、Microsoftアカウント自体の閉鎖とは別の手続きです。",
          "Microsoftアカウントの使用停止では、30日または60日の再開期間を選ぶ記載があります。",
          "再開期間を過ぎると、アカウントのデータとコンテンツは削除されます。",
        ],
      },
    ],
    contractRouteNotes: [
      {
        route: "Microsoftから購入したMicrosoft 365",
        management: "account.microsoft.com/services/microsoft365",
        notes: [
      ...
      {
        route: "定期請求をオフにする場合",
        management: "account.microsoft.com/services の対象サブスクリプション管理",
        notes: [
          "定期請求をオフにしても、有効期限までは通常どおり利用できます。",
        ],
      },
      {
        route: "App Store / Google Play / 小売業者経由",
        management: "各ストアまたは販売元の管理先",
        notes: [
          "キャンセル、更新、支払い方法変更、プラン切り替えなどは、課金パートナー側の管理サービスに分かれます。",
        ],
      },
      {
        route: "Microsoftアカウントの閉鎖",
        management: "Microsoftアカウント閉鎖ページ",
        notes: [
          "Microsoft 365サブスクリプションのキャンセルとは別に、Microsoftアカウント全体の使用停止として説明されています。",
        ],
      },
    ],
  },
...

  {
    ...
    officialLinks: [
      ...
      {
        label: "サポート / Zoom アカウントの削除",
        url: "https://support.zoom.com/hc/ja/article?id=zm_kb&sysparm_article=KB0067354",
      },
    ],
    cancellationEntryPoint: [
      ...
      "キャンセルには、アカウントオーナー、管理者、または請求権限を持つカスタムロールが必要とされています。",
      "対象のZoomサブスクリプションを所有するZoomアカウントにサインインできることも要件に含まれます。",
    ],
    billingRouteNotes: [
    ...
    cancellationTimingNotes: [
      ...
      "サブスクリプションをキャンセルすると将来の更新が停止し、現在のサブスクリプションはすぐには終了しません。",
      "再有効化されない限り、次回の更新時に請求されないと説明されています。",
      "営業の見積もりから購入したプランでリクエストされた変更は、見積に記載されている登録契約期間の終了時に実行されます。",
    ],
    postCancellationAccess: [
      "有料サブスクリプションが終了しても、クラウドレコーディングは30日間引き続き利用できます。",
      "30日後にクラウドレコーディングは完全に削除され、復元できないと記載されています。",
      "キャンセルが有効になる前であれば、既存のプランを再有効化できる手順があります。",
    ],
    cancellationVsAccountDeletion: [
      "ベーシック（無料）アカウントの場合はサブスクリプションがないため、アカウント削除で処理が完了すると説明されています。",
      "有料アカウントを削除するには、まずサブスクリプションをキャンセルし、現在の請求サイクルが終了するまで待つ必要があると記載されています。",
      "Zoomアカウントの削除は、ベーシック（無料）アカウントかつアカウントオーナーであることが要件です。",
      "アカウントを削除すると完全に削除されると説明されています。",
    ],
    confirmationNotes: [
      "プランのキャンセル時には確認ウィンドウが表示され、キャンセルが有効になる時期などの条件が通知されます。",
      "確定するには「キャンセルを確定」をクリックする案内です。",
      "変更を確認するEメールが送信されます。",
      "サブスクリプションのステータスは、期間終了までキャンセル保留中と表示される記載です。",
      "プラン一覧では、すべてのプランがそれぞれの更新日とともに表示されます。",
    ],
    unavailableOrExceptionNotes: [
      "アクティブなアドオンがある場合は、アドオンをキャンセルしてからベースプランをキャンセルする必要があります。",
      "アドオンが関連付けられた複数のサブスクリプションがある場合は、対象サブスクリプションをキャンセルする前に、各サブスクリプションのアドオンを個別にキャンセルする必要があります。",
      ...
      "Zoomサブスクリプションが別のアカウントまたは組織によって管理されている場合、自分でキャンセルできない場合があります。",
    ],
    officialSourceSummary:
      "Zoomのサポートでは、オンライン購入、営業見積もり経由、Google Playストア、Apple App Storeの購入経路ごとにキャンセル先が分かれています。Zoomウェブポータル内の請求ポータル位置に応じて、「プランと請求」または「アカウント管理」から対象プランを管理します。キャンセル要件、キャンセル保留中の表示、確認メール、アドオンを先にキャンセルする必要、クラウドレコーディングの30日間利用、ベーシックアカウント削除との違いも確認できます。",
    seoTitle:
      "Zoomの解約方法・請求ポータルと購入経路別の確認先",
    seoDescription:
      "Zoomの解約方法について、Zoomウェブポータルの請求ポータル、プランと請求、アカウント管理、Google Play・Apple App Store購入、営業見積もり経由の扱いを公式情報にもとづいて整理しています。",
    searchIntentNotes: [
      {
        title: "Zoomウェブポータル内の表示",
        items: [
          "請求ポータルの場所に応じて、「プランと請求」配下の「プラン管理」または「アカウント管理」配下の「請求」から対象プランを管理します。",
          "プラン一覧には、更新日とともにプランが表示されると記載されています。",
          "キャンセルには、アカウントオーナー、管理者、または請求権限を持つカスタムロールが必要です。",
        ],
      },
      {
        title: "キャンセル保留中・再アクティベート",
        items: [
          "変更確認メールが送信され、サブスクリプションのステータスは期間終了までキャンセル保留中と表示されます。",
          "キャンセルが有効になる前であれば、既存のプランを再有効化できます。",
          "複数のサブスクリプションがある場合は、各サブスクリプションを個別に再有効化する記載です。",
        ],
      },
      {
        title: "解約できない表示・アドオン",
        items: [
          "キャンセルオプションがグレーアウトしている場合は、自分でサブスクリプションをキャンセルできない可能性があると案内されています。",
          "「プランをキャンセル」オプションが表示されない場合は、ウェブポータルからプランをキャンセルできない旨のメッセージが表示されます。",
          "アクティブなアドオンがある場合は、ベースプランをキャンセルする前にアドオンをキャンセルします。",
        ],
      },
      {
        title: "無料アカウント削除との違い",
        items: [
          "ベーシック（無料）アカウントには有料サブスクリプションがないため、アカウント削除で処理が完了すると説明されています。",
          "有料アカウントは、サブスクリプションをキャンセルして現在の請求サイクルが終了した後にアカウント削除へ進む扱いです。",
          "アカウント削除は、ベーシック（無料）アカウントかつアカウントオーナーであることが要件です。",
        ],
      },
    ],
    contractRouteNotes: [
      {
        ...
        notes: [
          "Zoomウェブポータルから対象プランを管理する案内です。",
          "請求ポータルの場所により、「プランと請求」または「アカウント管理」配下から進みます。",
          "変更確認メールとキャンセル保留中のステータス表示が記載されています。",
        ],
      },
      {
        route: "営業見積もり経由",
      ...
      },
      {
        ...
        notes: [
          "Zoomウェブポータルに「プランをキャンセル」オプションは表示されません。",
        ],
      },
      {
        route: "アドオンがあるサブスクリプション",
        management: "各アドオンを個別にキャンセル",
        notes: [
          "ベースプランをキャンセルする前に、関連するアドオンを個別にキャンセルする必要があります。",
        ],
      },
      {
        route: "ベーシック（無料）アカウントの削除",
        management: "Zoomウェブポータルのアカウントプロファイル",
        notes: [
          "有料サブスクリプションのキャンセルとは別に、アカウントオーナーがアカウントを削除する手続きとして説明されています。",
        ],
      },
    ],
  },
...

  {
    ...
    officialLinks: [
      ...
      {
        label: "楽天モバイル お客様サポート / 楽天ミュージックを解約したい場合",
        url: "https://network.mobile.rakuten.co.jp/faq/detail/10000532/",
      },
      {
        label: "Rakuten Music / 料金プラン",
        url: "https://music.rakuten.co.jp/plan/",
      },
      {
        label: "Rakuten Music / ライトプラン",
        url: "https://music.rakuten.co.jp/plan/lite/",
      },
      {
        label: "Rakuten Music / バンドルプラン",
        url: "https://music.rakuten.co.jp/plan/bundle/",
      },
      {
        label: "ご契約内容の確認・変更",
        url: "https://member.music.rakuten.co.jp/",
      },
    ],
    cancellationEntryPoint: [
      "Rakuten MusicのWebサイトにある「ご契約内容の確認・変更」から解約できると記載されています。",
      "ライトプランページでは、ヘッダーメニュー内の「ご契約内容の確認・変更」または三メニュー内の同項目から、楽天IDでログインする流れが案内されています。",
      "プラン変更については、「ご利用プラン/料金」欄から行う記載があります。",
      "楽天モバイルのお客様サポートでは、無料トライアルの解約と有料プランの解約を分けて確認する構成です。",
    ],
    billingRouteNotes: [
      "楽天モバイルのお客様サポートでは、契約状況により解約方法が異なると説明されています。",
      "有料プランは、申し込み方法に合わせて解約手続きを行う案内です。",
      "料金プランページでは、アプリ内課金で申し込めるのはスタンダードプランとライトプランのみと記載されています。",
      "アプリ内課金の初回申込みは、1か月間無料の対象として掲載されています。",
      "楽天カード/モバイル会員対象プランは、支払い日時点で対象カードや楽天モバイル契約の状態を確認する記載です。",
      "アプリ内課金を利用中にWeb申込み対象のプランへ変更する場合は、一度アプリ内課金を解約した後にWebから申し込む必要があると記載されています。",
    ],
    cancellationTimingNotes: [
      "無料トライアル期間終了後は、契約したプランで自動更新（課金）となると記載されています。",
      "無料期間中に解約した場合は費用はかからないと案内されています。",
      "無料お試し（新規入会）が条件のキャンペーン以外は対象外となる注記があります。",
      "料金プランページでは、月額プランは30日間ごとの支払い、年額プランは360日間ごとの支払いとして掲載されています。",
    ],
    postCancellationAccess: [
      "楽天モバイルまたは楽天ブラックカード/楽天プレミアムカードを解約した場合、バンドルプランは一定期間（最大30日）経過後に利用できなくなると記載されています。",
    ],
    confirmationNotes: [
      "契約内容やプラン変更は、Rakuten Musicの「ご契約内容の確認・変更」から確認する導線です。",
      "ライトプランページでは、楽天IDでログイン後に「ご利用プラン/料金」欄を確認する流れが掲載されています。",
      "料金プランページでは、スタンダード、楽天カード/モバイル会員対象、学生、ライト、バンドル、年額プランが分けて掲載されています。",
      "バンドルプランは、契約中の楽天モバイルまたは対象カードと同じ楽天IDでログインする扱いです。",
    ],
    unavailableOrExceptionNotes: [
      "バンドルプランの場合、Rakuten Musicに登録されていないため解約の必要はなく、自動で課金されることはないと記載されています。",
      "楽天モバイルまたは楽天ブラックカード/楽天プレミアムカード契約中にバンドルプランを利用できない場合、該当する楽天IDでRakuten Musicアプリにログインしているか確認する案内があります。",
      "楽天モバイルの新規契約では認証まで3日から4日程度、楽天ブラックカードまたは楽天プレミアムカードの新規契約では受け取りから1日から2日ほどかかる場合があると記載されています。",
      "楽天カード/モバイル会員対象プランは、家族カード、楽天モバイルのデータタイプ、ドコモ回線・au回線などが対象外として掲載されています。",
    ],
    officialSourceSummary:
      "Rakuten Musicの公式ページでは、Webサイト上の「ご契約内容の確認・変更」から解約やプラン確認を行う導線が示されています。楽天モバイルのお客様サポートでは、無料トライアルと有料プランで確認先が分かれ、無料トライアル終了後は契約プランで自動更新されると説明されています。料金プランページには、30日間ごとの月額プラン、360日間ごとの年額プラン、アプリ内課金で申し込めるプラン、楽天カード/モバイル会員対象プラン、バンドルプランの注記が掲載されています。",
    seoTitle:
      "Rakuten Musicの解約方法・ご契約内容の確認先",
    seoDescription:
      "Rakuten Music（楽天ミュージック）の解約方法について、ご契約内容の確認・変更、無料トライアル、有料プラン、アプリ内課金、バンドルプランの扱いを公式情報にもとづいて整理しています。",
    searchIntentNotes: [
      {
        title: "楽天ミュージック表記と解約導線",
        items: [
          "Rakuten MusicのWebサイトにある「ご契約内容の確認・変更」からいつでも解約できると記載されています。",
          "「ご契約内容の確認・変更」は、公式サイトのヘッダーメニューまたは三メニューから開く流れです。",
          "楽天IDでログイン後、「ご利用プラン/料金」欄でプラン変更を行う案内があります。",
        ],
      },
      {
        title: "無料トライアル・支払い期間",
        items: [
          "無料トライアル期間終了後は、契約したプランで自動更新（課金）となります。",
          "無料期間中に解約した場合は費用はかからないと案内されています。",
          "月額プランは30日間ごと、年額プランは360日間ごとの支払いとして掲載されています。",
        ],
      },
      {
        title: "アプリ内課金・バンドルプラン",
        items: [
          "アプリ内課金で申し込めるのは、スタンダードプランとライトプランのみです。",
          "アプリ内課金からWeb申込み対象プランへ変更する場合は、一度アプリ内課金を解約した後にWebから申し込みます。",
          "バンドルプランの場合はRakuten Musicに登録されていないため、解約の必要はないと記載されています。",
        ],
      },
    ],
    contractRouteNotes: [
      {
        route: "Webサイトからの契約",
        management: "ご契約内容の確認・変更",
        notes: [
          "Rakuten MusicのWebサイト上の導線から、契約内容やプランを確認する扱いです。",
          "楽天IDでログイン後、「ご利用プラン/料金」欄を確認する流れです。",
        ],
      },
      {
        route: "アプリ内課金",
        management: "アプリ内課金側の解約後、Web申込み対象プランへ再申込み",
        notes: [
          "アプリ内課金で申し込めるのは、スタンダードプランとライトプランのみです。",
          "Web申込み対象プランに変更する場合は、一度アプリ内課金を解約した後にWebから申し込む必要があると記載されています。",
        ],
      },
      {
        route: "楽天カード/モバイル会員対象プラン",
        management: "対象カードまたは楽天モバイル契約の状態確認",
        notes: [
          "30日ごとの支払い日時点で、対象条件を満たしているかを確認する扱いです。",
          "対象外となるカードや回線種別が料金プランページに列挙されています。",
        ],
      },
      {
        route: "バンドルプラン",
        management: "Rakuten Musicへの登録なし",
        notes: [
          "解約の必要はなく、自動で課金されることはないと説明されています。",
          "楽天モバイルまたは楽天ブラックカード/楽天プレミアムカードを解約した場合、一定期間経過後に利用できなくなる記載があります。",
        ],
      },
    ],
  },
